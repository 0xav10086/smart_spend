...
// 响应式数据
const videoSource = ref<string>('/src/assets/err.mp4')
const errorMessage = ref<string>('You have lost your way')
const buttonText = ref<string>('return home')
...
.error-body .message h1:before {
  ...
  line-height: 0.5em;
  width: 100%;
  -webkit-animation: scan 500ms ease-in-out infinite alternate 508ms, glitch-anim 300ms ease-in-out infinite alternate;
          animation: scan 500ms ease-in-out infinite alternate 508ms, glitch-anim 300ms ease-in-out infinite alternate;
  overflow: hidden;
  opacity: 0.7;
}
.error-body .message h1:after {
  ...
  line-height: 0.1em;
  width: 100%;
  -webkit-animation: scan 665ms ease-in-out infinite alternate 581ms, glitch-anim 300ms ease-in-out infinite alternate;
          animation: scan 665ms ease-in-out infinite alternate 581ms, glitch-anim 300ms ease-in-out infinite alternate;
  overflow: hidden;
  opacity: 0.8;
}
